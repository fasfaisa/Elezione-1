    ...
    <div class="grid gap-4 grid-cols-1 md:grid-cols-2 place-items-center px-4 py-10">
      ...
      <form class="space-y-6 p-4 sm:p-6 md:p-8 bg-white border-2 border-blue-500 rounded-md w-full" action="#">
        ...
        <div>
          ...
          <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value="Peter Elwin" required />
        </div>
        <div>
          <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Your email <span class="text-red-500">*</span></label>
          <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value="peterelwin@abc.com" required />
        </div>
        <div>
