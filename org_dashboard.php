  ...
  <?php include_once "components/header.php" ?>
    ...
    <div>
      ...
      <div class="flex flex-col lg:flex-row min-h-[calc(100vh-18.05rem)]">
        <div
          class="flex flex-col bg-gray-300 py-4 px-2 md:px-4 lg:rounded-r-lg lg:shadow-sm lg:drop-shadow-sm"
        >
          ...
          <div class="mb-4">
            <div
              id="event-card"
              class="block my-4 w-full lg:w-[28rem] text-slate-100 p-6 bg-blue-400 rounded-lg shadow-xl drop-shadow-xl"
            >
            ...
            <div
              class="block my-4 w-full lg:w-[28rem] text-gray-600 p-6 bg-white rounded-lg shadow-xl drop-shadow-xl hover:bg-emerald-100"
            >
              <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900">
                2023-08-09 Program
              </h5>
            ...
            <div
              class="block w-full lg:w-[28rem] p-6 text-gray-600 bg-white rounded-lg shadow-xl drop-shadow-xl hover:bg-emerald-100"
            >
              <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900">
                2023-08-17 Program
              </h5>
        ...
        <div class="flex flex-col items-center w-full p-5">
          <div class="flex self-end mb-5 w-fit items-center space-x-3">
            <a href="settings.php"
              ><span
                class="material-symbols-outlined hover:text-green-600 duration-300 ease-in"
              >
                settings
              </span></a
            >
            <button
              id="new-campaign"
              class="bg-emerald-700 px-3 py-1.5 text-white rounded-md hover:bg-emerald-600 duration-300 ease-in"
            >
              New Campaign
            </button>
          </div>
          <div class="flex justify-between w-full md:ps-10">
            ...
            <div class="flex items-center">
              <label
                for="type-vote-count"
                class="block me-2 text-sm font-medium text-gray-900"
                >Type</label
              >
              <select
                id="type-vote-count"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-1.5 px-2"
              >
          ...
          <div class="flex justify-center w-full h-full" id="graph">
            <canvas
              id="votes"
              class="md:mx-10 max-w-[30rem] max-h-[30rem]"
            ></canvas>
          </div>
          ...
          <div class="w-full md:ps-10 my-10">
            ...
            <div class="">
              <button
                class="bg-yellow-400 px-4 py-2 mx-2 rounded-md shadow-sm drop-shadow-sm hover:bg-yellow-500 duration-300 ease-in"
              >
                Stop
              </button>
              <button
                class="bg-red-400 px-4 py-2 mx-2 rounded-md shadow-sm drop-shadow-sm hover:bg-red-500 duration-300 ease-in"
              >
                Delete
              </button>
              <button
                class="bg-slate-400 px-4 py-2 mx-2 rounded-md shadow-sm drop-shadow-sm hover:bg-slate-500 duration-300 ease-in"
              >
                Edit
              </button>
            </div>
    ...
    <div
      ...
      class="fixed z-50 scale-0 top-0 left-0 bg-transparent w-screen flex items-center h-screen justify-center px-2 duration-300 ease-in backdrop-blur-md overflow-y-scroll"
    >
      <form
        class="space-y-6 bg-white p-4 md:w-[38rem] sm:p-6 md:p-8 shadow-lg drop-shadow-lg rounded-md"
        action="#"
      >
        ...
        <div class="my-2">
          <label
            for="rules"
            class="block mb-2 text-sm font-medium text-gray-900"
            >Campaign rules <span class="text-red-500">*</span></label
          >
          <div id="rules" class="ms-5">
            <ul>
              <li class="flex items-center">
                <label for="vote-count" class="flex items-center"
                ...
                <input
                  ...
                  max="10"
                  value="1"
                  class="bg-gray-50 w-20 mx-5 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5"
                />
              </li>
            </ul>
          </div>
        ...
        <div class="w-full flex justify-center">
          <button
            type="submit"
            class="relative group mt-4 w-72 self-center bg-transparent z-[0] text-blue-700 hover:text-white border-blue-700 border-2 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-8 py-2 text-center overflow-hidden"
          >
            Create campaign
            <span
