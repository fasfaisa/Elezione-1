...
<body>
<div class = "h-auto min-h-screen flex py-3 justify-between items-center bg-slate-300/70 flex-col">
    <!-- logo -->
    <a href = "/" class = "ps-2 sm:ps-3 md:ps-4 place-self-start">
    ...
    <!--form div-->
    <div id = "form-div"
         class = "w-11/12 h-fit my-10 sm:w-[28rem] md:w-[30rem] max-w-lg bg-white border border-gray-200 rounded-lg shadow">
        <!-- user type selection-->
        <ul class = "flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 rounded-t-lg bg-gray-50"
            id = "regtab">
            <li class = "mr-2">
                <button id = "reg-voter" type = "button"
        ...
        <form class = "space-y-6 p-4 sm:p-6 md:p-8" id = "user-form">
            ...
            <div>
                ...
                <input type = "text" name = "name" id = "name"
                       ...
                       placeholder = "Peter Elwin" required/>
            ...
            <div class = "my-2 hidden" id = "package">
                <label for = "package" class = "block mb-2 text-sm font-medium text-gray-900">Package type <span
                            class = "text-red-500">*</span></label>
            ...
            <button id = "submit-btn" type = "submit" value = "voter" name = "voter"
    ...
    <!-- footer-->
    <p class = "text-gray-600 w-screen text-center text-sm">
