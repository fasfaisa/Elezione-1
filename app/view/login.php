...
<body>
    <div class="h-auto min-h-screen flex py-10 justify-center items-center bg-slate-300/70 flex-col">
        ...
        <!-- login card -->
        <div class="w-11/12 md:ms-10 sm:w-[25] max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8" id="login-card">
                ...
                <div class="flex items-start">
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <!-- remember me-->
                            <input id="remember" type="checkbox" name="remember" value="remember" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300" />
                        </div>
                        <label for="remember" class="ml-2 text-sm font-medium text-gray-900">Remember me</label>
                    </div>
                    <a href="forget" class="ml-auto text-sm text-blue-700 hover:underline">Forgot Password?</a>
                </div>
