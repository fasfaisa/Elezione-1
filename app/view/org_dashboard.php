...
<!-- process file-->
<?php include_once "../app/model/process/organizer_account_process.php" ?>
    ...
    <div class = "flex flex-col lg:flex-row min-h-[calc(100vh-18.05rem)]">
        ...
        <div class = "flex flex-col items-center w-full p-5">
            <div class = "flex self-end mb-5 w-fit items-center space-x-3">
                <a href = "dashboard/settings"><span
                ...
                <div class = "self-start">
                    <ul class = "ms-5">
                        <li class = "flex items-center space-x-3">
                            <img src = "/resources/tick.svg"
                                 class = "w-4 h-4"/><span>Maximum vote count for voter : 1</span>
                        </li>
                    </ul>
                </div>
            </div>
...
<div id = "new-campaign-form"
    ...
    <form class = "space-y-6 bg-white p-4 md:w-[38rem] sm:p-6 md:p-8 shadow-lg drop-shadow-lg rounded-md" action = "#">
        ...
        <!-- form input area -->
        <div class = "my-2">
            <label for = "name" class = "block mb-2 text-sm font-medium text-gray-900">Campaign name <span
                        class = "text-red-500">*</span>
            </label>

            <input type = "text" name = "name" id = "name"
                   class = "bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                   placeholder = "New Campaign" required/>
        </div>

        <!-- start -->
        <div class = "my-2">
            <label for = "sdate" class = "block mb-2 text-sm font-medium text-gray-900">Start Date & Time<span
                        class = "text-red-500">*</span>
            </label>
            <div class = "flex items-center">
        ...
        <!-- end -->
        <div class = "my-2">
            <label for = "edate" class = "block mb-2 text-sm font-medium text-gray-900">Start Date & Time<span
                        class = "text-red-500">*</span>
            </label>
            <div class = "flex items-center">
        ...
        <div class = "my-2">
            <label for = "rules" class = "block mb-2 text-sm font-medium text-gray-900">Campaign rules <span
                        class = "text-red-500">*</span></label>
            <div id = "rules" class = "ms-5">
                <ul>
                    <li class = "flex items-center">
                        <label for = "vote-count" class = "flex items-center"><span
                                    class = "material-symbols-outlined text-blue-600">
                  arrow_right
                </span>
                            Maximum vote count for voter
                        </label>
                        <input id = "vote-count" type = "number" min = "1" max = "10" value = "1"
