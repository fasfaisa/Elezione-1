...
<html lang="en">
  ...
  <?php include_once "components/header.php" ?>
    ...
    <div class="py-10">
      <div
        class="block mx-3 sm:mx-8 md:mx-12 lg:mx-16 xl:mx-20 p-6 py-8 px-4 sm:px-6 lg:px-8 bg-white border border-gray-200 rounded-lg shadow-xl drop-shadow-xl">

          <div class="bg-white py-24 sm:py-32">
              <div class="mx-auto max-w-7xl px-6 lg:px-8">
                  <div class="mx-auto max-w-2xl lg:text-center">
                      <h2 class="text-base font-semibold leading-7 text-blue-600">Elezione </h2>
                      <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Privacy Policy</p>
                      <p class="mt-6 text-lg leading-8 text-gray-600">
                          At Online Voting System, we value and prioritize the privacy of our
                          users. This Privacy Policy explains how we collect, use, and
                          disclose personal information when you use our online voting system
                          services.</p>
                  </div>
                    ...
                    info
                              ...
                              <dd class="mt-2 text-base leading-7 text-gray-600">
                                  ...
                                  <ul class="list-disc ml-8 mb-6">
                                      ...
                                      <li class="mb-2">Voting preferences</li>
                  ...
                  <span class="material-symbols-outlined text-white">
                    question_mark       </span>
                                  ...
                                  How We Use Your Information   </dt>
                              <div class="mt-2 text-base leading-7 text-gray-600">
                                  <p class="mb-4">We use your personal information to:</p>
                                  <ul class="list-disc ml-8 mb-6">
                                      <li class="mb-2">
                                          Facilitate and administer online voting processes
                                      </li>
                                      <li class="mb-2">
                                          Send you voting-related updates and notifications
                                      </li>
                                      <li class="mb-2">Improve our services and prevent fraud</li>
                                  </ul>
                              </div>
                          </div>
                          <div class="relative pl-16">
                  ...
                  <span class="material-symbols-outlined text-white">
                    verified_user
                  </span></div>Data Security</div>  </div>
                              <div class="mt-2 text-base leading-7 text-gray-600">
                                  <p class="mb-4">
                    ...
                    design_services
                              ...
                              <div class="mt-2 text-base leading-7 text-gray-600">
                                  <p class="mb-4">
                                      ...
                                      user data to improve our services. These third-party service
                  ...
                  <span class="material-symbols-outlined text-white">
                    report       </span>
                                      ...
                                      Changes to This Privacy Policy   </dt>
                              <div class="mt-2 text-base leading-7 text-gray-600">
                                  <p class="mb-4"> We reserve the right to modify this Privacy Policy at any time.
                  ...
                  <span class="material-symbols-outlined text-white">
                    gavel
                  </span></div>Legal Compliance </div>  </div>
                              <div class="mt-2 text-base leading-7 text-gray-600">
                                  <p class="mb-4">
                  ...
                  <span class="material-symbols-outlined text-white">
                    person
                  </span></div>Your Rights</div>
                              </div>
                              <div class="mt-2 text-base leading-7 text-gray-600">
                                  <p class="mb-4">
                                      You have the right to access and correct your personal information
                                      held by us. If you would like to review, update, or delete your
                                      personal information, please contact us using the information
                                      provided at the end of this Privacy Page.
                                  </p>
                  ...
                  <span class="material-symbols-outlined text-white">
                    contact_support
                  </span></div>Contact Us </div>  </div>
                              <div class="mt-2 text-base leading-7 text-gray-600">
                                  <p class="mb-4">
                                      If you have any questions, concerns, or requests regarding your
                                      privacy or the practices described in this Privacy Page, please
                                     <a href="contact" style="color: blue">contact us.</a>    </p>
                              </div>
                          </div>
