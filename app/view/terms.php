      ...
      <div class="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
        <div class="p-8 sm:p-10 lg:flex-auto">
          <h3 class="text-2xl font-bold tracking-tight text-gray-900">
            AGREEMENT TO OUR LEAGEL TERMS
          </h3>
          <p class="mt-6 text-base leading-7 text-gray-600">
            We are Elezione ('Company', 'we', 'us', or 'our'). This is a
            platform where you can vote for candidates. If you want to contact
            us just
            <a href="pages/contact.php" class="text-sm font-semibold leading-6 text-blue-600">Click here.</a>
            <br />These Legal Terms constitute a legally binding agreement
            made between you, whether personally or on behalf of an entity
            ('you'), and Elezione, concerning your access to and use of the
            ...
            <br />IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU
          ...
          <ul role="list" class="mt-8 grid grid-cols-1 gap-4 text-sm leading-6 text-gray-600 sm:grid-cols-1 sm:gap-6">
            ...
            <li class="flex gap-x-3">
              ...
              law or regulation. If you provide any information that is
            ...
            <li class="flex gap-x-3">
              ...
              <ol>
                ...
                <li>Unauthorized Sharing of Information</li>
                <li>Misrepresentation or Misinformation</li>
            ...
            <li class="flex gap-x-3">
              ...
              Services are hosted in Sri Lanka. If you access the Services
              from any other region of the world with laws or other
              requirements governing personal data collection, use, or
              disclosure that differ from applicable laws in Sri Lanka, then
              through your continued use of the Services, you are transferring
              your data to Sri Lanka, and you expressly consent to have your
              data transferred to and processed in Sri Lanka.
            </li>
          </ul>
        </div>
      </div>
