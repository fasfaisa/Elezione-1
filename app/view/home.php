...
<body>
    ...
    <section class="h-screen flex items-center relative -mt-[4.25rem] bg-slate-800">
        ...
        <div class="container z-50 mx-auto p-4">
            ...
            <p class="text-md md:text-lg xl:text-xl text-center text-gray-200 mb-12 italic">
                Cast your vote conveniently from anywhere, anytime.
            </p>
            <div class="flex justify-center">
                <a href="/register" class="bg-blue-500 text-white py-3 px-8 rounded-md shadow-lg hover:bg-emerald-500 transition-colors duration-300">Get Start</a>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 relative">
        ...
        <div class="mx-auto px-8 sm:px-16 md:px-24 lg:px-32 xl:px-40">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
                <div class="bg-white rounded-lg p-8 shadow-xl duration-300 ease-in group cursor-pointer hover:bg-yellow-300 text-gray-600 hover:text-gray-800">
            ...
            <!-- pricing org-->
            <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-5 mt-16" id="pricing">
                Pricing
                <span class="font-belanosima text-sky-600 text-xl md:text-3xl">for Organizations</span>
            </h2>
            <div class="w-full flex justify-center">
                <div class="w-fit grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 place-items-center">
                    <div class="w-[18rem] p-4 bg-white border-2 border-emerald-600 rounded-lg shadow-lg drop-shadow-lg">
                        ...
                        <a href="/register">
                            <button class="relative group mt-4 w-full self-center bg-transparent z-[0] text-blue-700 hover:text-white border-blue-700 border-2 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-8 py-2 text-center overflow-hidden">
                                Register
                                <span class="z-[-1] absolute w-full h-full -left-full top-0 bg-blue-700 group-hover:left-0 duration-200 ease-in"></span></button>
                        </a>
                    </div>
                    ...
                    <div class="w-[18rem] p-4 bg-white border-2 border-emerald-600 rounded-lg shadow-lg drop-shadow-lg">
                        ...
                        <div class="flex items-baseline text-gray-800">
                            ...
                            <span class="ml-1 text-xl font-normal text-gray-500">/Year</span>
                        </div>
                        <ul role="list" class="space-y-5 my-7">
                            <li class="flex space-x-3 items-center">
                                <img src="/resources/tick.svg" alt="tick" class="w-4 h-4" />
                    ...
                    <div class="w-[18rem] bg-white sm:translate-x-1/2 xl:translate-x-0 max-w-sm p-4 border-2 border-emerald-600 rounded-lg shadow-lg drop-shadow-lg">
                        <h5 class="mb-4 text-xl font-medium text-gray-500">
                            Platinum plan
                        </h5>
                        <div class="flex items-baseline text-gray-800">
            ...
            <!-- pricing voter -->
            <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-5 mt-16">
                Free
                <span class="font-belanosima text-sky-600 text-xl md:text-3xl">for Voters</span>
            </h2>
            <div class="flex w-full justify-center">
                <a href="/register">
                    <button class="relative group mt-4 w-[10rem] bg-transparent z-[0] text-blue-700 hover:text-white border-blue-700 border-2 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-8 py-2 text-center overflow-hidden">
                        Register FREE
                        <span class="z-[-1] absolute w-full h-full -left-full top-0 bg-blue-700 group-hover:left-0 duration-200 ease-in"></span></button>
                </a>
            </div>
