<footer class="bg-gray-800 pt-8">
    <div class="flex flex-col md:flex-row justify-center items-center mb-5">
        ...
        <a href="/privacy.php" class="text-white py-2 mx-4">Privacy</a>
        <a href="/pages/about.php" class="text-white py-2 mx-4">About</a>
        <a href="/pages/contact.php" class="text-white py-2 mx-4">Contact</a>
        <a href="/terms.php" class="text-white py-2 mx-4">T&C</a>
        <a href="/faq.php" class="text-white py-2 mx-4">FAQ</a>
    </div>
    <p
